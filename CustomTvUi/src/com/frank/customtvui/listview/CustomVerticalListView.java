...
public class CustomVerticalListView extends MAbsoluteLayout{
    ...
    private int mDuration = 300;
  	...
  	public CustomVerticalListView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		initView();
	}

	public CustomVerticalListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}

	public CustomVerticalListView(Context context) {
		super(context);
		initView();
	}
    ...
    public void setSelectionSmoothy(int position){
        ...
        Anim.trans(((IView)CustomVerticalListView.this), mTranslateX, mLocationY, mFlashListener);
    }
