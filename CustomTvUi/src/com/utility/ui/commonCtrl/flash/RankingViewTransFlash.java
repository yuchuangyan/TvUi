...
public class RankingViewTransFlash extends Flash {
	...
	public RankingViewTransFlash(IView view, int x, int y) {
		super(view);
	...
	public RankingViewTransFlash(IView view, int x, int y, int w, int h) {
		super(view);
